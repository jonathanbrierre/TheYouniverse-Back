...
class FollowingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create following" do
    assert_difference('Following.count') do
      post followings_url, params: { following: { followee_id: @following.followee_id, user_id: @following.user_id } }, as: :json
    end
  ...
  test "should update following" do
    patch following_url(@following), params: { following: { followee_id: @following.followee_id, user_id: @following.user_id } }, as: :json
    assert_response 200
  end
